<?php if ($this->session->flashdata('successConf')) : ?>
    <div class="alert alert-success alert-dismissible fade show alert-flashdata" role="alert">
        Updated Success.
...
<?php elseif ($this->session->flashdata('failConf')) : ?>
    <div class="alert alert-danger alert-dismissible fade show alert-flashdata" role="alert">
        Oops ! Updated Error .
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
